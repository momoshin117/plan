<x-app-layout>
   ...
   <h1>新規旅行スポット編集</h1>
   <form action='/myplan/spot/{{$travel_plan_spot->travel_plan_id}}/{{$travel_plan_spot->id}}/update' method='POST'>
      @csrf
      @method('PUT')
      ...
      <div class="departure_time">
         <input type="text" name="travel_plan_spot[departure_time]" value={{$travel_plan_spot->departure_time}}></input>
      </div>
